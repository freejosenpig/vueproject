<template>
  ...
  <div class="userlist">
    ...
    <div class="userlist-mian">
      ...
      <!--  id, n_name, n_sex, n_age, n_nation, n_phone, n_card, n_address, n_ephone, n_work,
    n_type, n_dept, n_img, n_work_date, n_money, n_ann, create_people, create_time, team_id -->
...
export default {
  ...
  methods: {
    ...
    findallroles() {
      ...
      var _this = this
      this.axios({
        url: 'http://localhost:8188/sysRole/findallroles',
        method: 'post',
      })
        .then(function (response) {
