	             ...
	             width="120">
				  ...
				  <el-form ref="form" :model="form" label-width="80px">
				  						  ...
				  						  <el-form-item label="最小规模">
				  						    <el-input v-model="form.minimumSize"></el-input>
				  						  </el-form-item>
				  						  <el-form-item label="剩余药品">
				  						    <el-input v-model="form.surplusmedine"></el-input>
				  						  </el-form-item>
				  						  <el-form-item label="药品结余状态">
				  						    <el-input v-model="form.balancestatus"></el-input>
				  						  </el-form-item>
										  <el-form-item>
										  <el-date-picker
		...
		created:function(){
		 ...
		 methods: {
			 ...
			 doQuery(params){
				 var that=this;
				 this.axios({
				   url: "http://localhost:8188/service/DrugSurplus",
				   method: "get",
			 ...
			 handleCurrentChange(val) {
			   ...
			   onSubmit(){
			   				  let DrugSuplusResult  =this.form;
			   				  console.log(DrugSuplusResult);
			   				  this.axios({
			   					   url: 'http://localhost:8188/service/DrugSurplusupdate',
			   					   method: 'POST',
			   					    data:DrugSuplusResult							 			
			  					        ...
			  					        var id=row.mes_Id;
			  					         this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
			  					           ...
			  					           type: 'warning'
			  								 ...
			  								 rows.splice(index, 1);
			  							     this.axios({
			  								 url: 'http://localhost:8188/service/DrugSurplusdelectbyid/'+id,
			  								 method: 'DELETE'
